...
| Pointer | Naar | Onderwerp |
|---------|------|-----------|
| Node 01 ──nidrā──→ Node 02 | `hexa-book-002.md` | frequentie-basis |
| Node 01 ──nidrā──→ Node 03 | `hexa-book-003.md` | audio-superpositie (E) |
| Node 01 ──nidrā──→ Node 04 | `hexa-book-004.md` | returnmedium (F) |
| Node 01 ──nidrā──→ Node 05 | `hexa-book-005.md` | Basmala / Abjad |
| Node 01 ──nidrā──→ Node 06 | `hexa-book-006.md` | dimensie 3: 3-6-9 veld |
| Node 01 ──nidrā──→ Node 07 | `hexa-book-007.md` | dimensie 4: expansie |
| Node 01 ──nidrā──→ Node 08 | `hexa-book-008.md` | dimensie 5: return zichtbaar |
| Node 01 ──nidrā──→ Node 09 | `hexa-book-009.md` | dimensie 6: terugkeer |
| Node 01 ──nidrā──→ Node 10 | `hexa-book-010.md` | dimensie 7: reflectie |
| Node 01 ──nidrā──→ Node 11 | `hexa-book-011.md` | synthese + fractaal |
| Node 01 ──nidrā──→ Node 12 | `hexa-book-012.md` | 24-brug + 6-bit routing |
| Node 01 ──nidrā──→ Node 13 | `hexa-book-013.md` | dimensie 8: onzichtbaar |
| Node 01 ──nidrā──→ Node 14 | `hexa-book-014.md` | dimensie 11: eka routing |
| Node 01 ──nidrā──→ Node 15 | `hexa-book-015.md` | dimensie 12: logos |
| Node 01 ──nidrā──→ Node 16 | `hexa-book-016.md` | dimensie 13: taal, veld, soevereiniteit |
| Node 01 ──nidrā──→ Node 17 | `hexa-book-017.md` | CC-construct (nidrā-router) |

Deze pointers zijn geen "volgende stap" — ze zijn tegelijk bestaande routes.
Zelfde code, verschillende routes → verschillende snelheden.

**Legacy monoliet:** `archive/hexa-book-legacy-full-v3.md` (niet gezaghebbend)
